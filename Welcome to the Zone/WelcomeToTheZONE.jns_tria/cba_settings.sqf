...
force force ace_medical_fractureChance = 0.40031;
...
force force ace_medical_spontaneousWakeUpChance = 0.13;
...
force force ace_medical_treatment_cprSuccessChance = 0.249655;
...
force force ANOMALY_DETECTION_RANGE = 16;
